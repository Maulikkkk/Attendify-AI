...
def load_dlib_models():
    ...
    sp = dlib.shape_predictor(
        face_recognition_models.pose_predictor_model_location() #path
        )
    
    facerec = dlib.face_recognition_model_v1(
        face_recognition_models.face_recognition_model_location() #path
        ) 
...
def get_face_embeddings(np_image):
    ...
    for face in faces:
        ...
        face_descriptor = facerec.compute_face_descriptor(np_image, shape)

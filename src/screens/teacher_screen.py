...
def teacher_screen_login():
    ...
    st.space()
    teacher_username= st.text_input("Enter username", placeholder = "sam_altman")
...
def teacher_screen_register():
    ...
    st.space()
    teacher_username= st.text_input("Enter username", placeholder = "sam_altman")
    teacher_name= st.text_input("Enter name", placeholder = "Sam Altman")
    teacher_password= st.text_input("Enter password", type ='password', placeholder = "Enter Password")
    ...
    btnc1,btnc2 = st.columns(2)
    with btnc1:
        st.button('Register now', icon=':material/passkey:', width='stretch')
    with btnc2:
